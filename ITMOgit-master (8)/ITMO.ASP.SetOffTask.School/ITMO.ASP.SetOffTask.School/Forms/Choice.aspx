<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/MasterPage.Master" AutoEventWireup="true" CodeBehind="Choice.aspx.cs" Inherits="ITMOSchool.Forms.Choice"  UnobtrusiveValidationMode="None"%>
                ...
                <div>
                    <div style="display:inline-flex">
                        <div style="margin:10px">
                            ...
                            <asp:TextBox ID="studentIdTB" runat="server" Height="18px" Width="178px"></asp:TextBox>
                        </div>
                        <div style="margin:10px">
                            <asp:Label ID="labelName" runat="server" Text="Имя" Width="50"></asp:Label>
                            <asp:TextBox ID="studentName" runat="server" Height="18px" Width="175px"></asp:TextBox>
                        </div>
                        <div style="margin:10px">
                        ...
                        <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="ITMOSchool.Context" EntityTypeName="" Select="new (CourseName, CourseId)" TableName="Courses">
                        </asp:LinqDataSource>
