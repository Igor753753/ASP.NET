<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Choice.aspx.cs" Inherits="ITMOSchoolASP.Choice"  UnobtrusiveValidationMode="None"%>
            ...
            <td>&nbsp;
                <div>
                    <div style="display:inline-flex">
                        ...
                        <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="ITMOScoolASP.Context" EntityTypeName="" Select="new (CourseName, CourseId)" TableName="Courses">
                        </asp:LinqDataSource>
